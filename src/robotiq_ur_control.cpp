#include "../include/robotiq_140_control/robotiq_ur_control.h"

GripperUR::GripperUR(){
    pub = nh.advertise<std_msgs::String>("/ur_driver/URScript",5);
    sub = nh.subscribe("/ur_driver/io_states",10, &GripperUR::gripper140_statusCallback,this);
...
void GripperUR::gripper140_statusCallback(const ur_msgs::IOStates::ConstPtr& msg_in){
